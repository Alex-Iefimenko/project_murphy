...
public class DefendState : StateBase {
	...
	private new int stateIndex = 15;
	private ICharacter enemy = null;
	private GameObject shot = null;

	public override int StateKind { get { return this.stateIndex; } }

	public DefendState (ICharacterAIHandler newHandler, AiStateParams param) : base(newHandler, param)
	{ 
	...
	{
		return enemy.CurrentRoom != movement.CurrentRoom || !stats.IsActive;
	}
